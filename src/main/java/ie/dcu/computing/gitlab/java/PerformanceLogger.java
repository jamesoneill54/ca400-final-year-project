...
public class PerformanceLogger {
    ...
    public void initialPrint(Node homeNode, Node goalNode, int numberOfObstacles, double pheromoneImportance, double distancePriority) {
        ...
        printWriter.println("OPTIMUM LENGTH\t|\t" + optimumLength);
        printWriter.println("OBSTACLES\t|\t" + numberOfObstacles);
        printWriter.println();
        printWriter.println("Pheromone Importance: " + pheromoneImportance);
        printWriter.println("Distance Priority: " + distancePriority);
    }
    ...
    public void finalPrint(List<Node> globalBestTour) {
        ...
        printWriter.println("Best tour order: " + globalBestTour);

...
2. [2. User Guide](#2-user-guide)
    - [2.1 Application Layout](#21-application-layout)
    - [2.2 Running a Simulation](#22-running-a-simulation)
    - [2.3 Changnig Variables](#23-changing-variables)
    - [2.4 Creating and Changing Obstacles](#24-creating-and-changing-obstacles)
...
Once you have installed, set up and opened the application, you should be met with the following User Interface

![UI-startup](./res/user-manual/ui.png)

This UI is comprised of the following componenets

#### 2.1.1 Status Panel

![Status Panel](./res/user-manual/status_panel.png)
...
#### 2.1.2 Simulation Runner Display

![Simulation Display](./res/user-manual/sim_display.png)
...
##### Purple - Global best trail
- The purple nodes forming a path between home and goal nodes represent the global best trail found overall in an attempt. This is displayed at the end of the simulation and overlays the pheromone trails beneath it.
...
![Empty Obstacle Panel](./res/user-manual/obst_panel_empty.png)
...
![Full Obstacle Panel](./res/user-manual/obst_panel_full.png)
...
Clicking the `-` button at the end of end of any obstacle's fields line will delete that object from the panel, and from the simulation. 
...
### 2.4 Creating and Changing Obstacles
